...
- Added an adolescent diagnostic-style Assessment Guide with consent, case history, screening checklist, connected speech recording, sound probes, reading/sentence samples, stimulability/cueing, listener support, and editable analysis.
...
SLPs can now open the app, choose a student and goal, run trials with minimal taps, or walk line-by-line through an adolescent diagnostic assessment with recording and structured analysis. The app drafts documentation while keeping the clinician in control.
